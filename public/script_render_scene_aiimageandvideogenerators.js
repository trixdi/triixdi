...
/////// VARS TO BE REPLACED
///////////////////////////////////////////////////////////////
var user_username_Placeholder = "AI Image and Video Generators";
var user_bio_Placeholder = ['Our directory showcases', 'an extensive collection of the best', '  AI image and video generators available.'];
var user_profile_pic_placeholder = "image_profile_pic_aiimageandvideogenerators.jpg"; 
var user_labels_link = ['PhotoAI, Create a new You',[ ' Leonardo AI' ,'A New Way of Creating Digital Art ']  ,[ 'BasedLabs is your go to source', ' for AI video and tools. '] ,[ 'Discover more tools','  Go to aiimageandvideogenerators.xyz' ] ];
var links_list = [['https://app.photoai.me/?via=aiimageandvideogenerators'], ['https://app.leonardo.ai/?via=aiimageandvideogenerators'], ['https://www.basedlabs.ai/?via=aiimageandvideogenerators'], [' https://www.aiimageandvideogenerators.xyz']];
var user_selected_background = "backgrounds/image_background_11.jpg";
var user_social_media_links = [['https://www.facebook.com/profile.php?id=61563458905838', 'facebook'],   ['mailto:aiimageandvideogenerators@gmail.com', 'emailadress']];
